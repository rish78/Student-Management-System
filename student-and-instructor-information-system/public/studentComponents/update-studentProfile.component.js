...
export default class UpdateStudentProfile extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:7000/api/messages/studentProfiles/'+ this.props.match.params.id)
            .then(response => {
                if(this.unmounted) 
                    return;
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:7000/api/messages/studentProfiles/update/'+ this.props.match.params.id, obj)
        ...
        return (
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Update Student Profile" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
